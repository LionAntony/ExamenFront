...
exports.getOperators = function (column) {
...
exports.sortColumnArray = function (columnName, columns, multiSort) {
...
exports.columnHasFilter = function (column) {
...
exports.createColumn = function (name, options) {
    var temp = options || {};
...
exports.isDateColum = function (column) {
...
exports.parseDateColumnValue = function (column, value) {
